...
public class NumberCaptchaInputView extends AppCompatEditText {
    ...
    public NumberCaptchaInputView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mCaptchaSize = a.getInt(R.styleable.NumberCaptcha_captchaSize, 6);
        a.recycle();
    ...
    private static class DefaultCaptchaDraw implements CaptchaDraw {
        private final int CURRENT_CURSOR_COLOR = 0xFF5D81DF;
        private final int DEFAULT_CURSOR_COLOR = 0xFFDFDFE0;
        private final int NUMBER_COLOR = 0xFF333333;
...
//                } else {
//                    canvas.drawRoundRect(new RectF(start, top, start + numberOccupyWidth, bottom), cornersSize, cornersSize, cursorPaint);
//                }
            }
        }
