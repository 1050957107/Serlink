...
public class XinaoViewPager extends ViewGroup {
    private static final String TAG = XinaoViewPager.class.getName();
    ...
    public XinaoViewPager(Context context) {
    ...
    public XinaoViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViewPager();
    }
