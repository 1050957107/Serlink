package com.xinao.serlinkoperate.notification;
...
public class MessageReceiver extends XGPushBaseReceiver {
		...
		if (customContent != null && customContent.length() != 0) {
			try {
				...
				if (!obj.isNull("key")) {
					...
					LoggerUtils.d(LogTag, "get custom value:" + value);
				}
				// ...
	...
	public void onNotificationShowedResult(Context context, XGPushShowedResult notifiShowedRlt) {
		...
		LoggerUtils.d(LogTag, "您有1条新消息, " + "通知被展示 ， " + notifiShowedRlt.toString() + ", PushChannel:" + notifiShowedRlt.getPushChannel());
	}
	...
	public void onSetAttributeResult(Context context, int i, String s) {
		LoggerUtils.e(LogTag,"onSetAttributeResult()");
	}

	@Override
	public void onDeleteAttributeResult(Context context, int i, String s) {
		LoggerUtils.e(LogTag,"onDeleteAttributeResult()");
	}
